...
size_canvas_x = 600 # Размер фиксированного окна
size_canvas_y = 600 # Размер фиксированного окна
...
def on_closing():
    global app_running
    if messagebox.askokcancel("Выход из игры", "Хотите выйти из игры?"): # иногда может не сработать !
        app_running = False
        tk.destroy()
...
tk.resizable(0, 0)
tk.wm_attributes("-topmost", 1) # Атрибут что бы игровое окно, было поверх других окон
